...
/**
 * HelpSupportDialog - A reusable dialog for Help & Support contact options
 * 
 * @param {boolean} isOpen - Whether the dialog is open
 * @param {function} onClose - Function to close the dialog
 */
const HelpSupportDialog = ({ isOpen, onClose }) => {
            ...
            <div className="relative bg-card border border-border rounded-2xl p-6 w-full max-w-sm mx-4 shadow-2xl animate-in zoom-in-95 fade-in duration-200">
                ...
                <div className="space-y-3">
                    ...
                    <a
                        ...
                        className="flex items-center gap-3 p-3 bg-blue-500/10 hover:bg-blue-500/20 rounded-xl transition-colors"
                    >
                        ...
                        <div>
                            ...
                            <p className="text-sm text-muted-foreground">support@astroconnect.com</p>
                        </div>
                    </a>
